  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <motion.aside
        ...
        className="fixed left-0 top-0 min-h-screen w-72 bg-gradient-to-b from-indigo-600 to-purple-700 text-white z-50 lg:translate-x-0 lg:static lg:z-auto"
      >
