...
const TeacherLayout: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'assignments', label: 'Assignments', icon: BookOpen, path: '/teacher/assignments', badge: 12 },
    ...
    { id: 'ai-review', label: 'AI Review Assistant', icon: Bot, path: '/teacher/ai-review' },
    { id: 'students', label: 'Students', icon: Users, path: '/teacher/students' },
    { id: 'notifications', label: 'Notifications', icon: Bell, path: '/teacher/notifications', badge: 5 },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <motion.aside
        ...
        className="fixed left-0 top-0 min-h-screen w-72 bg-gradient-to-b from-indigo-600 to-purple-700 text-white z-50 lg:translate-x-0 lg:static"
      >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-indigo-200">Teacher Portal</p>
                </div>
              </div>
          ...
          <div className="p-4 border-t border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-indigo-200 truncate">{user?.email || 'teacher@lpu.in'}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden lg:block">
                  <h2 className="text-xl font-semibold text-gray-900">
                    {navItems.find(item => item.path === location.pathname)?.label || 'Teacher Dashboard'}
                  </h2>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <Link to="/teacher/notifications" className="relative p-2 text-gray-600 hover:text-gray-900">
                ...
                <div className="relative">
                  ...
                  <AnimatePresence>
                    {profileDropdownOpen && (
                      ...
                      >
                        <Link to="/teacher/profile" onClick={() => setProfileDropdownOpen(false)} className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-50">
